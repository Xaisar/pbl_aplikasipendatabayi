                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Container(
                            ...
                            child: Text('Jadwal : ${homeC.posyandu.jadwal!}',
                                style: GoogleFonts.roboto(
                    ...
                    Flexible(
                      child: Stack(fit: StackFit.loose, children: [
                        Container(
                            ...
                            child: (homeC.riwayat.isEmpty
                                ? const Center(child: Text("Tidak Ada data"))
                                : ListView.builder(
                                    itemCount: homeC.riwayat.length,
                                        ...
                                        child: ListTile(
                                          ...
                                          title: Text(
                                              ...
                                              style: GoogleFonts.roboto(
                                                  ...
                                                  fontWeight: FontWeight.bold)),
                                          subtitle: Text(
                                              homeC.riwayat[index].posyandu!
                                                      .nama! +
                                                  "\n" +
                                                  homeC.riwayat[index].tanggal!,
                                              maxLines: 2,
                                              overflow: TextOverflow.ellipsis,
                                              style: GoogleFonts.roboto(
                                                  color: Colors.grey,
