                ...
                onPressed: () {
                  showDialog(
                      ...
                      builder: (context) {
                        return SideMenuView(
                            controller.bidan.id!,
                            controller.bidan.nama!,
                            controller.posyandu.nama!,
                            controller.posyandu.alamat!);
                      });
                },
                icon: const Icon(
                  Icons.menu,
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: Text('Jadwal : ${controller.posyandu.jadwal!}',
                            style: GoogleFonts.roboto(
                ...
                Flexible(
                  child: Stack(fit: StackFit.loose, children: [
                    Container(
                        ...
                        child: (controller.nullSafety.value == false
                            ? Center(
                                child: Text(
                                "Tidak Ada Data",
                                style: GoogleFonts.roboto(
                                ...
                                itemBuilder: (context, index) {
                                  return Container(
                                    ...
                                    child: ListTile(
                                      ...
                                      title: Text(
                                          controller.riwayat[index].bayi!.nama!,
                                          maxLines: 1,
                                          ...
                                          style: GoogleFonts.roboto(
                                              ...
                                              fontWeight: FontWeight.bold)),
                                      subtitle: Text(
                                          controller.riwayat[index].posyandu!
                                                  .nama! +
                                              "\n" +
                                              controller
